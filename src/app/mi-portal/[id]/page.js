...
export default function PortalCliente({ params }) {
  ...
  const t = {
    es: {
      ...
      errVacio: "Por favor, rellena todos los días y horas."
    },
    en: {
      ...
      errVacio: "Please fill in all dates and times."
    }
  }
        ...
        <div className="bg-orange-50 p-8 rounded-3xl shadow-sm border border-orange-100">
          ...
          {enviado ? (
            <div className="bg-green-100 text-green-800 p-8 rounded-2xl text-center border border-green-200">
              ...
              <p className="text-sm font-bold">{lang.okDesc}</p>
              <button onClick={() => setEnviado(false)} className="mt-6 text-xs font-black text-green-600 uppercase underline">{lang.btnOtro}</button>
            </div>
          ) : (
